...
public class Main {
    ...
    public static void readIntsFromInputAndPrintItUntilNegative() {
        int input = 1;    //proměnná se vytvoří, jakmile cylus začne a jakmile skončí, skončí i proměnná
        do {
            input = Support.safeReadInt();//while - opakuji, dokud neskončí podmínka
            System.out.println(input);
        } while (input >= 0);        //podmínka je, že proměnná musí být >= 0
    }
